...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-lsp-black-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12785&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-lsp-black-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-lsp-black` can be installed with:

```
conda install python-lsp-black
```

It is possible to list all of the versions of `python-lsp-black` available on your platform with:
